...
ifndef NO_USE_MIDI
INCPATH += `$(PKG_CONFIG) --cflags alsa`
LIBS += `$(PKG_CONFIG) --libs alsa`
endif
...
ifneq ($(TARGETOS),emscripten)
INCPATH += `$(PKG_CONFIG) --cflags fontconfig`
endif
LIBS += `$(PKG_CONFIG) --libs fontconfig`
...
ifndef NO_USE_QTDEBUG
INCPATH += `$(PKG_CONFIG) QtGui --cflags`
LIBS += `$(PKG_CONFIG) QtGui --libs`
endif
