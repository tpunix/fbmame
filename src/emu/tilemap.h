...
public:
	...
	int scrollx(int which = 0) const { return (which < (int)m_scrollrows) ? m_rowscroll[which] : 0; }
	int scrolly(int which = 0) const { return (which < (int)m_scrollcols) ? m_colscroll[which] : 0; }
	...
	void set_scrollx(int which, int value) { if (which < (int)m_scrollrows) m_rowscroll[which] = value; }
	void set_scrolly(int which, int value) { if (which < (int)m_scrollcols) m_colscroll[which] = value; }
